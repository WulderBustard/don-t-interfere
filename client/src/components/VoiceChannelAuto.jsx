...
const SIGNALING_SERVER = import.meta.env.VITE_VOICE_URL || API_BASE;
const ICE_CONFIG = { iceServers: [{ urls: "stun:stun.l.google.com:19302" }] };

export default function VoiceChannelAuto({
  channelId,
  displayName = "You",
  muted = false,
  onMembers,
  ...
  useEffect(() => {
    ...
    async function start() {
      ...
      socket.on("connect", () => {
        socket.emit("join-channel", { channelId: roomId, name: displayName });
      });
      ...
      socket.on("disconnect", closePeers);
    }
  ...
  }, [channelId, displayName, onMembers]);
